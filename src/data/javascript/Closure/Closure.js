export const Closure = {
  ...
  children: [
    ...
    {
      title: "3. Зачем нам замыкание?",
      type: "text",
      description: `
        <p>1. <strong>Data Encapsulation | Инкапсуляция данных:</strong> Позволяют скрыть переменные внутри функции, делая их недоступными извне, кроме как через другую функцию, созданную в той же области видимости.</p>
        <p>2. <strong>State persistence | Сохранение состояния:</strong> Позволяют сохранять состояние между вызовами функции, без использования глобальных переменных.</p>
        <p>3. <strong>Currying & Functional Programming | Каррирование и функциональное программирование:</strong> Облегчают каррирование и другие техники функционального программирования, позволяя функциям работать с переменными, которые были в их области видимости в момент создания.</p>
      `,
    },
    {
      title: "4. Пример замыкания",
      type: "text",
      description: `
...
myInnerFunction(); // Вывод: "I am outside!"
    ...
    {
      title: "6. Пример использования замыкания для приватных переменных",
      type: "text",
      description: `
...
console.log(counter.decrement()); // 1
    ...
    {
      title: "7. Замыкания и производительность",
      type: "text",
      description: `
