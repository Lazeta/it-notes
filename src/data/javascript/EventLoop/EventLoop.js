  ...
  children: [
    {
      ...
      description: `
        ...
        <ul>
          <li>Когда асинхронная операция (Promise, fetch) завершается, она помещается в очередь микро задач</li>
    ...
    },
    {
      ...
      description: `
        <ul>
          <li><strong>Микротаски</strong> (Promise, fetch) имеют высший приоритет и выполняются сразу после текущего стека, перед макротасками</li>
