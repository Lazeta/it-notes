    ...
    },
    {
      ...
      description: `
            <ul>
              ...
              <li><strong>Интеграция систем:</strong> Мобильные приложения общаются с сервером для получения и отправки данных (например, проверка погоды, отправка сообщений).</li>
            </ul>
          `,
    },
    {
